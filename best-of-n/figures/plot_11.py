...
FILAS = [
    ("Single sample",  "N=1",                        36.1, GRIS),
    ("Random",         "N=16, among those that answered", 43.5, GRIS),
    ("Majority vote",  "N=16",                       54.7, AZUL),
    ("Coverage",       "N=16, diagnostic ceiling",   74.5, VERDE),
]
TITULO = "GSM8K — and how much of the gain is actually selection"
SUB = ("Qwen2.5-0.5B-Instruct, weights frozen. 200 problems, 16 trajectories "
       "each, one consumer GPU.")
NOTAS = [
    "Random improves with N without selecting anything: with more trajectories, one of them usually did not abstain.",
    "Of the +18.6 points from N=1, only +11.3 come from voting. Exact McNemar vs random: p = 4.2e-07.",
]
...
fig.savefig("06_gsm8k_11.png",facecolor=FONDO,dpi=100)
print("guardado 06_gsm8k_11.png")
